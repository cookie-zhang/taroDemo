            ...
            <Dialog>
                <View className='addquetions'>
                    <View className='addquetions-body'>
                        ...
                        <Textarea onInput={this.onchangeDes.bind(this)} className='questions-des' placeholder='请输入描述' />
                        <View className='btn-group'>
                            <Button onClick={this.onokSub.bind(this)} className='btn-questions ok'>确定</Button>
